            ...
            <el-row>
                <el-form ref="form" class="newKan wyKan">
                    <el-col :span="24" class="wyAddHeaght"  style="padding-top:26px;">
                        <el-col :lg="12">
                            <el-col v-if="str == 'zy'" :lg="22" style="position: relative;margin-bottom: 0;">
...
<script>
    export default {
        ...
        watch:{
            dialogVisibleInfor(oldVal,newVal){
                this.showDialog = this.dialogVisibleInfor
            },
        },
        methods:{
            remoteMethod(query) {
                ...
                if(str == 'zy'){
                    this.$axios({
                        ...
                        if(res.data.code == '2004'){
                            ...
                            var add = params.houseAddr.split(',');
                            ...
                            if(params.attach){
                                ...
                                for(var j =0;j<img.length;j++){
                                    var obj4 = {}
                                    obj4['name']= img[j].split('#_#')[0]
                                    obj4['url']= img[j].split('#_#')[1]
