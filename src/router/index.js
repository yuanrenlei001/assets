...
export default new Router({
  routes: [
    ...
    {path: '/Index', name: 'Index', component: Index , meta: {title: '国有资产管理系统'},
        children:[
            {path: '/assets', name: 'assets', component: assets , meta: {title: '国有资产管理系统'}},
            {path: '/information', name: 'information', component: information , meta: {title: '国有资产管理系统'}},
            {path: '/maps', name: 'maps', component: maps , meta: {title: '国有资产管理系统'}},
            {path: '/property', name: 'property', component: property , meta: {title: '国有资产管理系统'}},
            {path: '/approval', name: 'approval', component: approval , meta: {title: '国有资产管理系统'}},
